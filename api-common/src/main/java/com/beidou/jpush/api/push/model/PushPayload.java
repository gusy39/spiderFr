package com.beidou.jpush.api.push.model;


import com.beidou.jpush.api.push.model.audience.Audience;
import com.beidou.jpush.api.push.model.notification.AndroidNotification;
import com.beidou.jpush.api.push.model.notification.IosNotification;
import com.beidou.jpush.api.push.model.notification.Notification;
import com.beidou.jpush.api.push.model.notification.PlatformNotification;
...
public class PushPayload implements PushModel {
    ...
    private final com.beidou.jpush.api.push.model.Platform platform;
    private final Audience audience;
    private final Notification notification;
    private final com.beidou.jpush.api.push.model.Message message;
    private com.beidou.jpush.api.push.model.Options options;
    private SMS sms;
    
    
    private PushPayload(com.beidou.jpush.api.push.model.Platform platform, Audience audience,
            Notification notification, com.beidou.jpush.api.push.model.Message message, com.beidou.jpush.api.push.model.Options options, SMS sms) {
    ...
    public void resetOptionsTimeToLive(long timeToLive) {
        if (null == options) {
            options = com.beidou.jpush.api.push.model.Options.newBuilder().setTimeToLive(timeToLive).build();
        } else {
    ...
    public static class Builder {
        ...
        public Builder setOptions(com.beidou.jpush.api.push.model.Options options) {
            this.options = options;
            return this;
        }
