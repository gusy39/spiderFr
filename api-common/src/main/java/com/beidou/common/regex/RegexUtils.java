package com.beidou.common.regex;
...
public class RegexUtils {
     ...
     * "^(13[0-9]|15[0-9]|18[0|2|6|8|9]|17[0|7]|14[0-9])\\d{8}$";
     */
    public static final String MOBILE = "^(13[0-9]|17[0-9]|15[0-9]|18[0-9]|17[0|7]|14[0-9])\\d{8}$";
     ...
     * 微博@用户 取得用户名
     */
    public static final String WEBBO_AT_ME = "@(.*?)(\\s|:)";
    ...
    /* 2."^(http|https|ftp)\\:\\([a-zA-Z0-9\\.\\-]+(\\:[a-zA-"
            ...
            + "[^/][a-zA-Z0-9\\.\\,\\?\\'\\\\/\\+&%\\$\\=~_\\-@]*)*$";*/
    public static final String URL = "(?:http:\\/\\/)?([\\w.]+[\\w\\/]*\\.[\\w.]+[\\w\\/]*\\??[\\w=\\&\\+\\%]*)";
 ...
 //------------------验证方法
    ...
    public static String[] atMe(String content) {
        return matcherAll(content, WEBBO_AT_ME);
    }
    /**
    ...
    public static boolean matcher(String string, String reg) {
        boolean tem = false;
    ...
    public static String[] matcherAll(String str, String pattern) {
        System.out.println("pattern=" + pattern);
        if (null == str || str.trim().length() <= 0)
            return new String[]{};
        Pattern p = Pattern.compile(pattern);
        ...
        String groupA[] = new String[groups.size()];
        return groups.toArray(groupA);
    }
    ...
    public static void main(String[] args) {
        System.out.println(isMobile("13021989299"));
    }
}
