...
//        System.out.println(ajax);
        String ajax2 = HttpClientUtils.sendGetRequest("https://list.tmall.com/search_product.htm?type=p&spm=a220m.1000858.a2227oh.d100&from=.list.pc_1_searchbutton", header,null);
        //判断关键字符
