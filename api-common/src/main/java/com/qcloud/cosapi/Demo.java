...
public class Demo {
	...
	public static final int APP_ID = 10018471;
	public static final String SECRET_ID = "AKIDkrq44fNAs6AObAIxzj6zOUosNQkLQvWW";
	public static final String SECRET_KEY = "S3ovg6F0hRtYve6vJHh0qILssOTy3FaV";
